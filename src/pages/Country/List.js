...
function CountryList() {
  ...
  return (
      <Skeleton>
          <div className='p-10'>
              <TopComponent title="Setting" component="Country" current="List" />
              <div className='w-auto bg-white mt-10 rounded-lg shadow-2l pb-2'>
                  <div className='p-5 border-b border-#6c6c6c-500  m-b-2 flex justify-between'>
                      ...
                      <div className='px-8 py-3'>
                          <CircularButton title={'New Country'} bgColor={'btn-bg-green'} bgColorHover={''} onClick ={()=>navigate("/country/create")}/>
                      </div>
                  </div>
