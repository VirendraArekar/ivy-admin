...
function SourceList() {
    const columns = [
        ...
        },
        {
            name: "Status",
            cell: (row) => <div 
                className='py-1 px-5 my-2 text-sm font-medium text-green-700 focus:outline-none bg-green-100 rounded-full border border-green-700 w-28 text-center'
            >
              ...
              <div className='w-auto bg-white mt-10 rounded-lg shadow-2l pb-2'>
                  <div className='p-5 border-b border-#6c6c6c-500  m-b-2 flex justify-between'>
                      ...
                      <div className='px-8 py-3'>
                          <CircularButton title={'New Source'} bgColor={'btn-bg-green'} bgColorHover={''} />
                      </div>
                  </div>
